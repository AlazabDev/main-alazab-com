-- إصلاح المشاكل وتبسيط النظام مع إزالة التبعيات أولاً
...
-- 7. إنشاء دالة بسيطة لإنشاء profile تلقائياً
